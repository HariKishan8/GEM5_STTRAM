// Auto generated C++ code started by /home/ksrikond/work/gem5/src/mem/slicc/symbols/StateMachine.py:1064
                                ...
                                if ((((*in_msg_ptr)).m_Type == DMARequestType_READ)) {
                                    ...
                                    ;
                                        ...
                                        if ((((*in_msg_ptr)).m_Type == DMARequestType_WRITE)) {
                                            ...
                                            panic("Runtime Error at MI_example-dir.sm:206: %s.\n", ("Invalid message"));
                                            ;
                                        }
                                    }
                                    }
                                        ...
                                        if ((((*in_msg_ptr)).m_Type == CoherenceRequestType_GETX)) {
                                            ...
                                            ;
                                                ...
                                                if ((((*in_msg_ptr)).m_Type == CoherenceRequestType_PUTX)) {
                                                        ...
                                                        panic("Runtime Error at MI_example-dir.sm:227: %s.\n", ("Invalid message"));
                                                        ;
                                                    }
                                                }
                                            }
                                ...
                                if ((((*in_msg_ptr)).m_Type == MemoryRequestType_MEMORY_READ)) {
                                    ...
                                    ;
                                        ...
                                        if ((((*in_msg_ptr)).m_Type == MemoryRequestType_MEMORY_WB)) {
                                            ...
                                            DPRINTF(RubySlicc, "MI_example-dir.sm:244: %s\n", ((*in_msg_ptr)).m_Type);
                                            panic("Runtime Error at MI_example-dir.sm:245: %s.\n", ("Invalid message"));
                                            ;
                                        }
                                    }
                                    }
