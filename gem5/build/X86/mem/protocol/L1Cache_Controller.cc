...
L1Cache_Controller::b_issuePUT(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, const Address& addr)
{
    ...
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MI_example-cache.sm:266: %s.\n", "assert failure");
    ...
    assert(in_msg_ptr != NULL); // Check the cast result
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MI_example-cache.sm:279: %s.\n", "assert failure");
    ...
    assert(in_msg_ptr != NULL); // Check the cast result
{
    ...
    #ifndef NDEBUG
    if (!((m_tbe_ptr != NULL))) {
        panic("Runtime Error at MI_example-cache.sm:293: %s.\n", "assert failure");
...
L1Cache_Controller::r_load_hit(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, const Address& addr)
{
    ...
    #ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MI_example-cache.sm:339: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MI_example-cache.sm:346: %s.\n", "assert failure");

}
#endif
;
DPRINTF(RubySlicc, "MI_example-cache.sm:347: %s\n", (*m_cache_entry_ptr).m_DataBlk);
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MI_example-cache.sm:370: %s.\n", "assert failure");
...
L1Cache_Controller::forward_eviction_to_cpu(L1Cache_TBE*& m_tbe_ptr, L1Cache_Entry*& m_cache_entry_ptr, const Address& addr)
{
    DPRINTF(RubyGenerated, "executing forward_eviction_to_cpu\n");
        if (m_send_evictions) {
        DPRINTF(RubySlicc, "MI_example-cache.sm:377: Sending invalidation for %s to the CPU\n", addr);
...
#ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at MI_example-cache.sm:394: %s.\n", "assert failure");
