 ...
 *
 * Auto generated C++ code started by /home/ksrikond/work/gem5/src/mem/slicc/symbols/StateMachine.py:444
    ...
    assert(in_msg_ptr != NULL); // Check the cast result
{
    ...
    #ifndef NDEBUG
    if (!((m_tbe_ptr != NULL))) {
        panic("Runtime Error at MI_example-dir.sm:309: %s.\n", "assert failure");
    ...
    assert(in_msg_ptr != NULL); // Check the cast result
{
    ...
    #ifndef NDEBUG
    if (!((m_tbe_ptr != NULL))) {
        panic("Runtime Error at MI_example-dir.sm:325: %s.\n", "assert failure");
...
Directory_Controller::da_sendDMAAck(Directory_TBE*& m_tbe_ptr, const Address& addr)
{
    ...
    #ifndef NDEBUG
    if (!((m_tbe_ptr != NULL))) {
        panic("Runtime Error at MI_example-dir.sm:338: %s.\n", "assert failure");
...
Directory_Controller::dwt_writeDMADataFromTBE(Directory_TBE*& m_tbe_ptr, const Address& addr)
{
    ...
    #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at MI_example-dir.sm:400: %s.\n", "assert failure");
    ...
    assert(in_msg_ptr != NULL); // Check the cast result
{
    ...
    DPRINTF(RubySlicc, "MI_example-dir.sm:454: %s\n", *out_msg);
    ...
    assert(in_msg_ptr != NULL); // Check the cast result
{
    ...
    DPRINTF(RubySlicc, "MI_example-dir.sm:468: %s\n", *out_msg);
    ((*m_memBuffer_ptr)).enqueue(out_msg, Cycles((1)));
}
}
    ...
    assert(in_msg_ptr != NULL); // Check the cast result
{
    ...
    (*out_msg).m_MessageSize = ((*in_msg_ptr)).m_MessageSize;
    DPRINTF(RubySlicc, "MI_example-dir.sm:484: %s\n", *out_msg);
    ((*m_memBuffer_ptr)).enqueue(out_msg, Cycles((1)));
}
}
    ...
    assert(in_msg_ptr != NULL); // Check the cast result
{
    ...
    #ifndef NDEBUG
    if (!((m_tbe_ptr != NULL))) {
        panic("Runtime Error at MI_example-dir.sm:492: %s.\n", "assert failure");
    ...
    (*out_msg).m_MessageSize = ((*in_msg_ptr)).m_MessageSize;
    DPRINTF(RubySlicc, "MI_example-dir.sm:502: %s\n", *out_msg);
    ((*m_memBuffer_ptr)).enqueue(out_msg, Cycles((1)));
}
}
    ...
    assert(in_msg_ptr != NULL); // Check the cast result
{
    ...
    (*out_msg).m_DataBlk = ((*in_msg_ptr)).m_DataBlk;
    (*out_msg).m_MessageSize = ((*in_msg_ptr)).m_MessageSize;
    DPRINTF(RubySlicc, "MI_example-dir.sm:519: %s\n", *out_msg);
    ((*m_memBuffer_ptr)).enqueue(out_msg, Cycles((1)));
}
}
...
Directory_Controller::w_writeDataToMemoryFromTBE(Directory_TBE*& m_tbe_ptr, const Address& addr)
{
    ...
    #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at MI_example-dir.sm:529: %s.\n", "assert failure");

}
#endif
;
(*(getDirectoryEntry(addr))).m_DataBlk = (*(((*m_TBEs_ptr)).lookup(addr))).m_DataBlk;
        ...
        if ((((*m_directory_ptr)).isPresent(param_addr))) {
                if ((param_state == Directory_State_M)) {
                    ...
                    if (!(((((*(getDirectoryEntry(param_addr))).m_Sharers).count()) == (0)))) {
                        panic("Runtime Error at MI_example-dir.sm:146: %s.\n", "assert failure");
                ...
                (*(getDirectoryEntry(param_addr))).m_DirectoryState = param_state;
                    if ((param_state == Directory_State_I)) {
                        ...
                        #ifndef NDEBUG
                        if (!(((((*(getDirectoryEntry(param_addr))).m_Sharers).count()) == (0)))) {
                            panic("Runtime Error at MI_example-dir.sm:153: %s.\n", "assert failure");
