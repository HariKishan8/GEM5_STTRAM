...
def getEventQueue(*args):
  return _event.getEventQueue(*args)
...
class Event(EventBase,m5.internal.serialize.Serializable):
    ...
    def globalEvent(self): return _event.Event_globalEvent(self)
...
class EventQueue(m5.internal.serialize.Serializable):
    ...
    def name(self, *args): return _event.EventQueue_name(self, *args)
    ...
    def setCurTick(self, *args): return _event.EventQueue_setCurTick(self, *args)
    def getCurTick(self): return _event.EventQueue_getCurTick(self)
    ...
    def handleAsyncInsertions(self): return _event.EventQueue_handleAsyncInsertions(self)
    def replaceHead(self, *args): return _event.EventQueue_replaceHead(self, *args)
    def lock(self): return _event.EventQueue_lock(self)
    def unlock(self): return _event.EventQueue_unlock(self)
...
class GlobalSimLoopExitEvent(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def getCause(self): return _event.GlobalSimLoopExitEvent_getCause(self)
    def getCode(self): return _event.GlobalSimLoopExitEvent_getCode(self)
    def __init__(self, *args): 
        this = _event.new_GlobalSimLoopExitEvent(*args)
        try: self.this.append(this)
        except: self.this = this
